...
class SignleDream extends StatefulWidget {
  var drr;

  SignleDream(s, {super.key}){
    drr = s;
  }


  @override
  State<SignleDream> createState() => _SignleDream(drr);
}

class _SignleDream extends State<SignleDream> {
