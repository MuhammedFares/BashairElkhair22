...
class ReadOnlyFinishedDream extends StatefulWidget {
  var drr;

  ReadOnlyFinishedDream(s, {super.key}){
    drr = s;
  }


  @override
  State<ReadOnlyFinishedDream> createState() => _ReadOnlyFinishedDream(drr);
}

class _ReadOnlyFinishedDream extends State<ReadOnlyFinishedDream> {
  var Formkey = GlobalKey<FormState>();

  _ReadOnlyFinishedDream(drr);
                    ...
                    children: [
                      Row (
                        children: [
                          ...
                          Container(
                            margin: const EdgeInsets.only(top: 55.0,right:10.0).r,
                            width: 230.0.w,
                            height: 90.0.h,
