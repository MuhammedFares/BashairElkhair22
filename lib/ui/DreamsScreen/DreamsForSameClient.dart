...
class DreamsForSameClient extends StatefulWidget {
  var dr;

  DreamsForSameClient(drx, {super.key}) {dr =drx;}

  @override
  State<DreamsForSameClient> createState() => _DreamsForSameClientState(dr);
}

class _DreamsForSameClientState extends State<DreamsForSameClient> {
  var Formkey = GlobalKey<FormState>();

  _DreamsForSameClientState(dr);
