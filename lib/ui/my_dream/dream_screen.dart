...
import 'package:bshair_elkher/ui/DreamsScreen/DoneDreams.dart';
...
import '../DreamsScreen/NotDoneDreams.dart';
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    InkWell(
                      onTap: () async {
                        var x = await UserFinishedDreams();
                       String y = x.length.toString();
                        Navigator.push(context, MaterialPageRoute(builder:
                            (context)=> new DoneDreams(x,y)));
                      },
                      child: Container(
                    ...
                    InkWell(
                      onTap: () async {
                        var x = await UserNotFinished();
                        String y = x.length.toString();
                        Navigator.push(context, MaterialPageRoute(builder:
                            (context)=> new NotDoneDreams(x,y)));
                      },
                      child: Container(
                        padding: EdgeInsets.only(top: 15.0).r,
                        width: double.infinity,
