...
class youssef extends StatefulWidget {

  @override
  State<youssef> createState() => _youssefState();
}

class _youssefState extends State<youssef> {
  @override
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      " داعية اسلامي وبكالوريوس في الشريعة و ماجيستير ودكتوراه في الارشاد النفسي ودبلوم عالي في الارشاد الاسري \n",
                  ...
                  Container(
                    ...
                    child: Text(
                      "مفسر ومعبر للرؤي والاحلام لعدد من القنوات الفضائية والإذاعية والجرائد والمجلات لما يقارب ثلاثة عقود من الزمان",
                      textAlign: TextAlign.center,
                      style: GoogleFonts.notoKufiArabic(
                        fontSize: 14.0.sp,
                        fontWeight: FontWeight.w700,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'خبير في التخطيط والتطوير للذات وبيئة العمل',
                          style: GoogleFonts.notoKufiArabic(
                            fontSize: 14.0.sp,
                            fontWeight: FontWeight.w700,
