...
class thwaiba extends StatefulWidget {

  @override
  State<thwaiba> createState() => _thwaibaState();
}

class _thwaibaState extends State<thwaiba> {
  @override
              ...
              Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "10 سنوات من الخبرة في مجال تأويل الرؤي والاحلام ولي مؤلفين في تفسير الأحلام وقواعده",
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "مفسرة لعدد من القنوات الفضائية وكاتبة ",
                          textAlign: TextAlign.center,
                          style: GoogleFonts.notoKufiArabic(
                            fontSize: 14.0.sp,
                            fontWeight: FontWeight.w700,
                  ...
                  Container(
                    ...
                    child: Text(
                    " ليسانس لغة عربية ودراسات إسلامية \n  دبلومة شريعة اسلامية \n دبلومة ارشاد نفسي واسري \n درست برواق الازهر الشريف ",
                      textAlign: TextAlign.center,
                      style: GoogleFonts.notoKufiArabic(
                        fontSize: 14.0.sp,
                        fontWeight: FontWeight.w700,
                  ...
                  Container(
                    ...
                    child: Text(
                      "اعتمد على الكتاب والسنة والدراسات الإسلامية في تأويل الرؤي وتفسيرها و أعمد فى توضيح كل من نفسك ورؤياك من خلال ما يخبئ عقلك الباطن وتعكسه احلامك كذلك أحلل شخصيتك ضمن التفسير كنوع من إكمال الصورة لصاحب الرؤيا",
                      textAlign: TextAlign.center,
                      style: GoogleFonts.notoKufiArabic(
                        fontSize: 14.0.sp,
                        fontWeight: FontWeight.w700,
